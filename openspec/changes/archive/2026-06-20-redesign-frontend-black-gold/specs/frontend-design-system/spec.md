...
- **THEN** **Mark as complete** uses the shared gold primary-action treatment and visible keyboard focus
- **THEN** pending and completed states remain explicit without relying on color alone
