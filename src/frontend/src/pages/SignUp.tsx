...
function SocialButton({ icon, label, id }: { icon: React.ReactNode; label: string; id: string }) {
    return (
        <button
            id={id}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-start gap-2.5 pt-1">
                            <button
                                ...
                                className={`mt-0.5 w-[18px] h-[18px] shrink-0 rounded-[5px] border flex items-center justify-center transition-all duration-200 cursor-pointer ${
                                    agreeTerms
                        ...
                        <button
                            ...
                            className={`w-full text-white font-semibold text-sm py-3.5 rounded-xl transition-all duration-200 shadow-lg shadow-purple-500/20 mt-4! ${
